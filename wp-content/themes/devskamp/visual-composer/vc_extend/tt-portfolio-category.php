...
if (function_exists('vc_map')) :
    ...
    vc_map( array(
        'name'        => esc_html__( 'TT Portfolio Category', 'materialize' ),
        'base'        => 'tt_portfolio_category',
        'icon'        => 'fa fa-th',
        ...
        'params'      => array(
            ...
            array(
                'type'          => 'autocomplete',
                'heading'       => esc_html__( 'Portfolio from category', 'trendymag' ),
                'param_name'    => 'taxonomies',
                'settings'      => array(
                    'multiple'      => true,
                    'values'        => materialize_portfolio_category_slug(),
                    'unique_values' => true,
                    'display_inline' => true
                ),
                'param_holder_class' => 'vc_not-for-custom',
                'description' => esc_html__( 'Enter categories name to show portfolio from specific category, multiple category allowed', 'trendymag' )
            ),
    ...
    if (class_exists('WPBakeryShortCode')) {
        class WPBakeryShortCode_tt_Portfolio_Category extends WPBakeryShortCode {
        }
    }
endif;