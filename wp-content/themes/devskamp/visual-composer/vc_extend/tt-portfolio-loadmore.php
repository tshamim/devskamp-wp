...
if (function_exists('vc_map')) :
    ...
    vc_map( array(
        'name'        => esc_html__( 'TT Portfolio loadmore', 'materialize' ),
        'base'        => 'tt_portfolio_loadmore',
        'icon'        => 'fa fa-th',
        'category'    => esc_html__( 'TT Elements', 'materialize' ),
        'description' => esc_html__( 'To showcase your portfolio grid view with loadmore', 'materialize' ),
        'params'      => array(
            ...
            array(
                'type'          => 'textfield',
                'heading'       => esc_html__( 'Loadmore text', 'materialize' ),
                'param_name'    => 'loadmore_text',
                'value'         => esc_html__( 'Loadmore', 'materialize' ),
                'description'   => esc_html__( 'Change Loadmore text', 'materialize' )
            ),
    ...
    if (class_exists('WPBakeryShortCode')) {
        class WPBakeryShortCode_tt_Portfolio_Loadmore extends WPBakeryShortCode {
        }
    }
endif;