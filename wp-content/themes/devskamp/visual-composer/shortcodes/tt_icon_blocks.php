<?php
    ...
    if ($tt_atts['featured_block_style'] == 'animated-carousel') {
        $wrapper_class = "featured-carousel";
    }

?>

    <div class="<?php echo esc_attr($wrapper_class .' '. $tt_atts['block_hover_style'].' '.$tt_atts['featured_block_style'].' '.$tt_atts['el_class'].' '.$css_class.' '.$grid_column_class); ?>">
